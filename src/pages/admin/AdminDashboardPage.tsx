  ...
  const checkUserAndRole = useCallback(async () => {
    ...
    if (currentUser) {
      try {
        ...
        setIsAdmin(false);
        toast.error("Error al verificar el rol del usuario. Acceso denegado.");
        navigate('/');
      }
    } else {
      setIsAdmin(false);
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground max-w-3xl mx-auto text-balance">
              Gestiona todas las publicaciones del blog.
            </p>
            <div className="mt-6">
          ...
          {posts.length === 0 && !loading && !error ? (
            <div className="text-center p-10 bg-card rounded-lg shadow-lg">
              <p className="text-xl text-foreground font-semibold text-balance">No hay publicaciones en el blog para administrar.</p>
            </div>
          ) : (
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Esta acción no se puede deshacer. Esto eliminará permanentemente la publicación "{post.title}".
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
